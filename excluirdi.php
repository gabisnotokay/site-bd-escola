<!DOCTYPE html>
    ...
    <form name="cliente" method = "POST" action = "">
        <fieldset id="a">
            <legend><b>Informe o código da disciplina em que deseja deletar:</b></legend>
                <p> Código: <input name="txtcod" type="text" size="40" maxlenght="40" placeholder="Código da Disciplina">
    ...
    if(isset($btnenviar))
    {
        ...
        $di=new Disciplina();
        $di->setMat ($txtcod);
        echo "<h3><br><br>" . $di->exclusaoDi() . "</h3>";
    }
    ?>
