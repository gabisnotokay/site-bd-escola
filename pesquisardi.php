<!DOCTYPE html>
    ...
    <form name="cliente" method = "POST" action = "">
        <fieldset id="a">
            <legend><b>Informe o Nome que deseja pesquisar:</b></legend>
                <p> Nome: <input name="txtname" type="text" size="40" maxlenght="40" placeholder="Nome da Disciplina">
                <br><br><center>
    ...
    if(isset($btnenviar))
    {
        ...
        $di=new Disciplina();
        $di->setNome ($txtname .'%');
        $di_bd=$di->consultarDi();
        foreach($di_bd as $di_mostrar)
            {
                ?> <br>
                <b> <?php echo "Código: " . $di_mostrar[0]; ?> </br>
                <b> <?php echo "Nome: " . $di_mostrar[1]; ?> </br>
                <?php
            }
    }
    ?>
