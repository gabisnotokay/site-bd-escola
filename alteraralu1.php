<!DOCTYPE html>
    ...
    <center><font face="Century Gothic" size="6"><b>Alteração de Alunos Matriculados</b><font size="4"></center><br>
        
        <font face="Century Gothic" size="3"><b>

        <form name = "cliente" method = "POST" action = "alteraralu2.php">
        <fieldset>
            <legend><b> Informe a matrícula desejada: </b></legend>
                <p> Matrícula: <input name = "txtmat" type = "text" size = "20" maxlength = "5" palceholder = "Matricula">
                <br><br><center>
