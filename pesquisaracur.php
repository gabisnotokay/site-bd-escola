<!DOCTYPE html>
    ...
    <form name="cliente" method = "POST" action = "">
        <fieldset id="a">
            <legend><b>Informe o Nome que deseja pesquisar:</b></legend>
                <p> Nome: <input name="txtname" type="text" size="40" maxlenght="40" placeholder="Nome do Curso">
                <br><br><center>
    ...
    if(isset($btnenviar))
    {
        ...
        $cur=new Disciplina();
        $cur->setNome ($txtname .'%');
        $cur_bd=$cur->consultarDi();
        foreach($cut_bd as $cur_mostrar)
            {
                ?> <br>
                <b> <?php echo "Código: " . $cur_mostrar[0]; ?> </br>
                <b> <?php echo "Nome: " . $cur_mostrar[1]; ?> </br>
                <b> <?php echo "Código 1: " . $cur_mostrar[2]; ?> </br>
                <b> <?php echo "Código 2: " . $cur_mostrar[3]; ?> </br>
                <b> <?php echo "Código 3: " . $cur_mostrar[4]; ?> </br>
                <?php
            }
    }
    ?>
